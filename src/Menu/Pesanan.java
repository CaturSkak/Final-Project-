...
public class Pesanan extends javax.swing.JFrame {
    ...
    public Pesanan() {
        ...
        String [] header = {"No","Tanggal","Nama","Alamat","telepon","Pesanan","Ukuran","Jumlah","Harga"};
...
new MenuUtama().show();
    ...
    private void SumbitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SumbitActionPerformed
        try {
            ...
            Connection con = ObjKoneksi.bukaKoneksi();
            Statement st = con.createStatement();
            String sql = "delete from laporan where No = '" + nomer.getText() + "' ";
        ...
        try {
            ...
            Connection con = ObjKoneksi.bukaKoneksi();
            Statement st = con.createStatement();
            String sql = "delete from pengambilan where No = '" + nomer.getText() + "' ";
            int row = st.executeUpdate(sql);
            if (row == 1) {
        ...
        try {
            ...
            Connection con = ObjKoneksi.bukaKoneksi();
            Statement st = con.createStatement();
            String sql = "delete from proses where No = '" + nomer.getText() + "' ";
            int row = st.executeUpdate(sql);
            if (row == 1) {
        ...
        try {
            ...
            Connection con = ObjKoneksi.bukaKoneksi();
            Statement st = con.createStatement();
            String sql = "delete from pesanan where No = '" + nomer.getText() + "' ";
            int row = st.executeUpdate(sql);
            if (row == 1) {
